...
The objective of the assginment is to propose a model, train it with the
...
The namimg convention used for variables containing IMU measurement in the data
...
which means that we expect that we can precict the 20 test cases correctly with a probability of
